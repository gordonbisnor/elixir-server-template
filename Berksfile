...
cookbook 'percona' # sphinx?
cookbook 'yum', github: 'opscode-cookbooks/yum' # sphinx?
cookbook 'yum-epel', github: 'opscode-cookbooks/yum-epel' # sphinx?
cookbook 'sphinx', github: 'jesseadams/sphinx-cookbook' # gbi
cookbook 'backup', github: 'gofullstack/backup-cookbook' # gbi
cookbook 'pg-backup', github: 'gordonbisnor/pg-backup-cookbook' # gbi